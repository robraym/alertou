...
final class MotorolaOfferMonitor {
    static final String ACTION_STATUS_CHANGED = "br.com.droidboaoferta.MOTOROLA_OFFER_STATUS_CHANGED";
    private static final String PREFS = "motorola_offer_monitor";
    ...
    private static final MotorolaOfferMonitor INSTANCE = new MotorolaOfferMonitor();

    private Context appContext;
    private final CoalescingCheckScheduler scheduler = new CoalescingCheckScheduler();

    private MotorolaOfferMonitor() {
    }

    static MotorolaOfferMonitor getInstance() {
        return INSTANCE;
    }
            ...
            for (ExternalProductDeal deal : deals) {
                for (Interest interest : interests) {
                    ...
                    ObservedOffer offer = new ObservedOffer(
                            "motorola|" + interest.getId() + "|" + deal.getId(), interest.getId(),
    ...
    private void showNotification(Context context, ObservedOffer offer) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context,
                ...
                .setContentTitle(offer.getDisplayTitle()).setContentText(explanation)
